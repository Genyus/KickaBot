...
var self = module.exports = {
  ...
  renderMatchStats: function renderMatchStats (error, feed, teams, callback) {
    ...
    var homeTeamStats = commentary.comm_match_stats.localteam;
    var awayTeamStats = commentary.comm_match_stats.visitorteam;
    var width = 39;
    ...
    utils.mergeArrayValues([
      'Possess.',
      homeTeamStats.possestiontime.total,
      awayTeamStats.possestiontime.total
    ], cells, 'text');
    buffer.push(self.writeRow(cells));
    utils.mergeArrayValues([
      'Shots',
      homeTeamStats.shots.total,
      awayTeamStats.shots.total
    ], cells, 'text');
    buffer.push(self.writeRow(cells));
    utils.mergeArrayValues([
      'On Target',
      homeTeamStats.shots.ongoal,
      awayTeamStats.shots.ongoal
    ], cells, 'text');
    buffer.push(self.writeRow(cells));
    utils.mergeArrayValues([
      'Corners',
      homeTeamStats.corners.total,
      awayTeamStats.corners.total
    ], cells, 'text');
    buffer.push(self.writeRow(cells));
    utils.mergeArrayValues([
      'Offsides',
      homeTeamStats.offsides.total,
      awayTeamStats.offsides.total
    ], cells, 'text');
    buffer.push(self.writeRow(cells));
    utils.mergeArrayValues([
      'Saves',
      homeTeamStats.saves.total,
      awayTeamStats.saves.total
    ], cells, 'text');
    buffer.push(self.writeRow(cells));
    utils.mergeArrayValues([
      'Fouls',
      homeTeamStats.fouls.total,
      awayTeamStats.fouls.total
    ], cells, 'text');
    buffer.push(self.writeRow(cells));
    utils.mergeArrayValues([
      'Yellows',
      homeTeamStats.yellowcards.total,
      awayTeamStats.yellowcards.total
    ], cells, 'text');
    buffer.push(self.writeRow(cells));
    utils.mergeArrayValues([
      'Reds',
      homeTeamStats.redcards.total,
      awayTeamStats.redcards.total
    ], cells, 'text');
    buffer.push(self.writeRow(cells));
